...
jQuery Webpack 5 setup for small static projects and legacy frontend code.

Use this template when a project still needs jQuery, but you want modern tooling around it: module imports, Sass, PostCSS, asset handling, linting, tests, and production builds.
...
- `src/scripts/main.js` - jQuery entry.
